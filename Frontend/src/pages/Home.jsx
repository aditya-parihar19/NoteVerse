...
export default function HomePage() {
  return (
    <div className="bg-[#F8F9FA] text-gray-900 font-sans w-full">
      ...
      {/* Hero Section */}
      <header className="relative bg-gradient-to-r from-[#F8F9FA] to-[#8ECAE6] text-white py-16">
        {/* Container to center content with max width */}
        <div className="flex flex-col md:flex-row items-center justify-between max-w-6xl mx-auto px-6 w-full">
          ...
          {/* Right Image */}
            <div className="md:w-1/2 mt-10 md:mt-10 flex justify-center md:justify-end pt-4 md:pt-8">
              <img
                src="/hero-section-img.png"
                alt="Study Illustration"
                className="w-4/5 md:w-3/4 max-w-sm md:max-w-md h-auto rounded-xl shadow-xl hover:shadow-2xl"
              />
            </div>
      ...
      {/* Features Section */}
      <section className="py-16 px-6 md:px-20 bg-[#F8F9FA] max-w-6xl mx-auto">
        <h2 className="text-3xl font-bold text-center mb-12 text-[#023047]">Features</h2>
      ...
      {/* Call to Action */}
      <section className="bg-gradient-to-r from-[#80ED99] via-[#B1A7F3] to-[#8ECAE6] text-[#023047] py-16 px-6 text-center max-w-6xl mx-auto">
